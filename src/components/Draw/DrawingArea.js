...
const DrawingArea = () => {
  ...
  const handleMouseDown = (e) => {
    ...
    //  added the case of selecting sticky notes tool 
    else if(selectedTool === "stickyNotes"){
      handleAddNote(pos.x, pos.y, 200, 250, "Rectangle")
      setSelectedTool("");
    }
  };
  // Functions calling when the mouse move on the board for start drawing
  ...
  const handleAddNote = (posX, posY, w, h, shape) => {
    setNotes([
      ...notes,
      {
        x: posX,
